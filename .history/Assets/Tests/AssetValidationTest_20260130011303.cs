...
public class AssetValidationTest
{
    ...
    public void Factory_Assets_Have_Valid_Prefabs()
    {
        ...
        Assert.Greater(characterDataCollection.Length, 0, "No CharacterData found. Did you created the CharacterData scriptable obejct yet ?");

        foreach(string characterData in characterDataCollection)
        {
